...
import { Box, Center, IconButton, Tbody, Td, Text, Th, Thead, Tr, useMediaQuery } from "@chakra-ui/react";
...
const Blacklist = () => {
  ...
  const sortedSongs = useMemo(() => {
    ...
    const blacklistedSongs: Song[] = songs.filter((song) => song.blacklisted);
  ...
  if (songs.length === 0) {
    return <PageWrapper>
      <Center>No songs added yet, your list is empty!</Center>
    </PageWrapper>
  }
